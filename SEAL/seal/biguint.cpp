...
namespace seal
{
    ...
    void BigUInt::resize(int bit_count)
    {
        ...
        size_t new_uint64_count = static_cast<size_t>(divide_round_up(bit_count, bits_per_uint64));
    ...
    BigUInt &BigUInt::operator =(const BigUInt& assign)
    {
        ...
        // Copy over value.
        size_t assign_uint64_count = static_cast<size_t>(
