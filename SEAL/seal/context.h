    ...
    */
    struct EncryptionParameterQualifiers
    {
        ...
        */
        ...
        /**
        Tells whether modulus switching is enabled for these parameters. This is currently
        set to be always true.
        */
        bool using_modulus_switching;
    ...
    */
    ...
    public:
        ...
        public:
            ...
            */
            inline auto &total_coeff_modulus() const
            {
                return total_coeff_modulus_;
            }

            /**
            Returns a const reference to the polynomial modulus.
            */
            inline auto &poly_modulus() const
            {
        ...
        private:
            ContextData(EncryptionParameters parms,
                const MemoryPoolHandle &pool) : pool_(pool), parms_(parms) 
            {
                if (!pool_)
                {
            ...
            util::Pointer<std::uint64_t> total_coeff_modulus_anchor_;

            util::Modulus total_coeff_modulus_;

            util::Pointer<std::uint64_t> poly_modulus_anchor_;
        ...
        */
        static auto Create(const EncryptionParameters &parms)
        {
            return std::shared_ptr<SEALContext>(
                new SEALContext(parms, MemoryManager::GetPool()));
        }
