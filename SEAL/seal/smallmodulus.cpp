...
namespace seal
{
    void SmallModulus::save(ostream &stream) const
    {
        ...
        uint64_t uint64_count64 = uint64_count_;
        stream.write(reinterpret_cast<const char*>(&uint64_count64), sizeof(uint64_t));
    ...
    void SmallModulus::load(istream &stream)
    {
        ...
        uint64_t uint64_count64;
        stream.read(reinterpret_cast<char*>(&uint64_count64), sizeof(uint64_t));
        uint64_count_ = uint64_count64;
