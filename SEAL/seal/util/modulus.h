...
namespace seal
{
    namespace util
    {
        ...
        public:
            ...
            Modulus(const std::uint64_t *modulus, std::size_t uint64_count);

            Modulus(const std::uint64_t *modulus, std::size_t uint64_count, MemoryPool &pool);
        ...
        private:
            ...
            Pointer<std::uint64_t> inverse_modulus_;
        };
    }
}