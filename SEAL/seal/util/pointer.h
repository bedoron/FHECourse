...
namespace seal
{
    namespace util
    {
        ...
        public:
            ...
            // Move of the same type
            Pointer(Pointer<SEAL_BYTE> &&source, SEAL_BYTE value) noexcept :
            ...
            inline SEAL_BYTE *get()
            {
                return data_;
            }

            inline const SEAL_BYTE *get() const
            {
                return data_;
            }
        ...
        public:
            ...
            inline auto &operator =(Pointer<T> &&assign)
            {
                acquire(std::move(assign));
                return *this;
            }
        ...
        public:
            ...
            inline static ConstPointer<SEAL_BYTE> Owning(SEAL_BYTE *pointer) noexcept
            {
                return {pointer, false};
            }

            inline static ConstPointer<SEAL_BYTE> Aliasing(const SEAL_BYTE *pointer) noexcept
            {
        ...
        private:
            ...
            ConstPointer(SEAL_BYTE *pointer, bool alias) : data_(pointer), alias_(alias)
            {
            }
        ...
        public:
            ...
            inline static ConstPointer<T> Owning(T *pointer)
            {
                return {pointer, false};
            }

            inline static ConstPointer<T> Aliasing(const T *pointer)
            {
        ...
        private:
            ...
            ConstPointer(T *pointer, bool alias) : data_(pointer), alias_(alias)
            {
            }
        ...
        {
            return Pointer<T>(pool.get_for_byte_count(count * sizeof(T)), 
                std::forward<Args>(args)...);
        }
