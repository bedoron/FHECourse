...
namespace seal
{
    namespace util
    {
            ...
            size_t result_coeff_uint64_count, uint64_t *result, MemoryPool &pool)
        {
            ...
            {
                multiply_poly_poly(intermediateptr, result_coeff_count, result_coeff_uint64_count, 
                    value, value_coeff_count, value_coeff_uint64_count, result_coeff_count, 
                    result_coeff_uint64_count, productptr, pool);
                const uint64_t *curr_coeff = get_poly_coeff(
                    poly_to_eval, poly_to_eval_coeff_count, poly_to_eval_coeff_uint64_count);
                add_uint_uint(productptr, result_coeff_uint64_count, curr_coeff, 
                    poly_to_eval_coeff_uint64_count, false, result_coeff_uint64_count, productptr);
            ...
            size_t result_coeff_uint64_count, std::uint64_t *result, MemoryPool &pool)
        {
            ...
            auto big_alloc(allocate_uint(
                (result_coeff_count + result_coeff_count + result_coeff_count) * 
