...
namespace seal
{
    namespace util
    {
        inline void right_shift_poly_coeffs(const std::uint64_t *poly, std::size_t coeff_count, 
            std::size_t coeff_uint64_count, int shift_amount, std::uint64_t *result)
        {
#ifdef SEAL_DEBUG
        ...
        inline void negate_poly(const std::uint64_t *poly, std::size_t coeff_count, 
        ...
        inline void add_poly_poly(const std::uint64_t *operand1, const std::uint64_t *operand2, 
            std::size_t coeff_count, std::size_t coeff_uint64_count, std::uint64_t *result)
        {
#ifdef SEAL_DEBUG
        ...
        void multiply_poly_poly(const std::uint64_t *operand1, std::size_t operand1_coeff_count, 
        ...
        inline void poly_infty_norm(const std::uint64_t *poly, std::size_t coeff_count, 
            std::size_t coeff_uint64_count, std::uint64_t *result)
        {
        ...
        void poly_eval_poly(const std::uint64_t *poly_to_eval, std::size_t poly_to_eval_coeff_count, 
