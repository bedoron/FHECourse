...
namespace seal
{
    namespace util
    {
        ...
        public:
            ...
            inline std::uint64_t get_from_inv_root_powers_div_two(std::size_t index) const
            {
#ifdef SEAL_DEBUG
                if (index >= coeff_count_)
                {
            ...
            inline std::uint64_t get_from_scaled_inv_root_powers_div_two(std::size_t index) const 
            {
#ifdef SEAL_DEBUG
                if (index >= coeff_count_)
                {
