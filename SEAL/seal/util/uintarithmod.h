...
namespace seal
{
    namespace util
    {
        void modulo_uint_inplace(std::uint64_t *value, std::size_t value_uint64_count, 
            const Modulus &modulus, MemoryPool &pool);

        inline void modulo_uint(const std::uint64_t *value, std::size_t value_uint64_count, 
            ...
            std::uint64_t *result, MemoryPool &pool)
        {
            ...
            std::size_t uint64_count = modulus.uint64_count();
            std::size_t intermediate_uint64_count = uint64_count * 2;
            ...
            std::uint64_t *result, MemoryPool &pool)
        {
            ...
            // Calculate normal product.
            std::size_t uint64_count = modulus.uint64_count();
            std::size_t result_uint64_count = uint64_count * 2;
