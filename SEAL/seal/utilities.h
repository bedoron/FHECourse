...
namespace seal
{
    ...
    */
    ...
    value, and finally outputs the largest of them all. 
    ...
    */
    ...
    BigUInt. The input is expected to be already reduced modulo the modulus.
    ...
    */
    ...
    is expected to be already reduced modulo the modulus.
    ...
    */
    BigUInt exponentiate_uint_mod(const BigUInt &operand, const BigUInt &exponent, 
        const BigUInt &modulus, const MemoryPoolHandle &pool = MemoryManager::GetPool());
    ...
    reduced both modulo the polynomial and the coefficient modulus.
    ...
    */
    void poly_eval_poly(const BigPoly &poly_to_evaluate, const BigPoly &poly_to_evaluate_at, 
        BigPoly &destination, const MemoryPoolHandle &pool = MemoryManager::GetPool());
    ...
    */
    BigPoly poly_eval_poly_polymod_coeffmod(const BigPoly &poly_to_evaluate, 
        const BigPoly &poly_to_evaluate_at, const BigPoly &poly_modulus, 
        const BigUInt &coeff_modulus, const MemoryPoolHandle &pool = MemoryManager::GetPool());
