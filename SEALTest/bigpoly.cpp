...
namespace SEALTest
{
    ...
    public:
        ...
        {
            BigPoly poly;
            Assert::AreEqual(0ULL, poly.coeff_count());
            Assert::AreEqual(0, poly.coeff_bit_count());
            Assert::IsTrue(nullptr == poly.data());
            Assert::AreEqual(0ULL, poly.uint64_count());
        ...
        {
            BigPoly poly(3, 100);
            Assert::AreEqual(3ULL, poly.coeff_count());
            Assert::AreEqual(100, poly.coeff_bit_count());
            Assert::IsTrue(nullptr != poly.data());
            Assert::AreEqual(6ULL, poly.uint64_count());
            Assert::AreEqual(0ULL, poly.significant_coeff_count());
            Assert::IsTrue("0" == poly.to_string());
            Assert::IsTrue(poly.is_zero());
            ...
            Assert::AreEqual(1ULL, poly.significant_coeff_count());
            ...
            Assert::AreEqual(3ULL, poly.significant_coeff_count());
            ...
            Assert::AreEqual(3ULL, poly.uint64_count());
            ...
            poly.resize(4, 100);
            Assert::AreEqual(4ULL, poly.coeff_count());
            Assert::AreEqual(100, poly.coeff_bit_count());
            Assert::AreEqual(8ULL, poly.uint64_count());
            Assert::IsTrue("12345678x^2 + 456x^1 + 123" == poly.to_string());
            Assert::AreEqual(static_cast<uint64_t>(0x123), poly.data()[0]);
            Assert::AreEqual(static_cast<uint64_t>(0), poly.data()[1]);
            Assert::AreEqual(static_cast<uint64_t>(0x456), poly.data()[2]);
        ...
        TEST_METHOD(BigPolyFromString)
        {
            ...
            Assert::AreEqual(1ULL, poly.coeff_count());
