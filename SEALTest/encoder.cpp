...
namespace SEALTest
{
    ...
    public:
        TEST_METHOD(BinaryEncodeDecodeBigUInt)
        {
            ...
            Assert::AreEqual(64ULL, poly4.coeff_count());
            for (int i = 0; i < 64; ++i)
            {
            ...
            Assert::AreEqual(20ULL, poly5.coeff_count());
            for (int i = 0; i < 20; ++i)
            {
        ...
        TEST_METHOD(BalancedEncodeDecodeBigUInt)
        {
            ...
            value = "1";
            Plaintext poly1 = encoder.encode(value);
            Assert::AreEqual(1ULL, poly1.significant_coeff_count());
            Assert::IsTrue("1" == poly1.to_string());
            Assert::IsTrue(value == encoder.decode_biguint(poly1));

            value = "2";
            Plaintext poly2 = encoder.encode(value);
            Assert::AreEqual(2ULL, poly2.significant_coeff_count());
            Assert::IsTrue("1x^1 + FFFF" == poly2.to_string());
            Assert::IsTrue(value == encoder.decode_biguint(poly2));

            value = "3";
            Plaintext poly3 = encoder.encode(value);
            Assert::AreEqual(2ULL, poly3.significant_coeff_count());
            Assert::IsTrue("1x^1" == poly3.to_string());
            Assert::IsTrue(value == encoder.decode_biguint(poly3));

            value = "2671";
            Plaintext poly4 = encoder.encode(value);
            Assert::AreEqual(9ULL, poly4.significant_coeff_count());
            for (int i = 0; i < 9; ++i)
            {
                Assert::IsTrue(poly4[i] == 1);
            }
            ...
            value = "D4EB";
            Plaintext poly5 = encoder.encode(value);
            Assert::AreEqual(11ULL, poly5.significant_coeff_count());
            for (int i = 0; i < 11; ++i)
            {
                if (i % 3 == 1)
                {
        ...
        TEST_METHOD(BinaryEncodeDecodeUInt32)
        {
            ...
            Assert::AreEqual(32ULL, poly4.significant_coeff_count());
            for (int i = 0; i < 32; ++i)
            {
                Assert::IsTrue(1 == poly4[i]);
            }
            ...
            Assert::AreEqual(20ULL, poly5.significant_coeff_count());
            for (int i = 0; i < 20; ++i)
            {
                if (i == 19 || (i >= 8 && i <= 11) || i == 1)
                {
        ...
        TEST_METHOD(BinaryEncodeDecodeInt64)
        {
            ...
            Assert::AreEqual(1ULL, poly4.significant_coeff_count());
            ...
            Assert::AreEqual(2ULL, poly5.significant_coeff_count());
            ...
            Assert::AreEqual(2ULL, poly6.significant_coeff_count());
            ...
            Assert::AreEqual(51ULL, poly7.significant_coeff_count());
            for (int i = 0; i < 51; ++i)
            {
            ...
            Assert::AreEqual(52ULL, poly8.significant_coeff_count());
            ...
            Assert::AreEqual(20ULL, poly9.significant_coeff_count());
            for (int i = 0; i < 20; ++i)
            {
                if (i == 19 || (i >= 8 && i <= 11) || i == 1)
                {
            ...
            Assert::AreEqual(11ULL, poly10.significant_coeff_count());
        ...
        TEST_METHOD(BalancedEncodeDecodeInt64)
        {
            ...
            Assert::AreEqual(9ULL, poly7.significant_coeff_count());
            for (int i = 0; i < 9; ++i)
            {
            ...
            Assert::AreEqual(9ULL, poly8.significant_coeff_count());
            ...
            Assert::AreEqual(11ULL, poly9.significant_coeff_count());
            for (int i = 0; i < 11; ++i)
            {
                if (i % 3 == 1)
                {
            ...
            Assert::AreEqual(11ULL, poly11.significant_coeff_count());
        ...
        TEST_METHOD(EncodeDecodeInt32)
        {
            ...
            Assert::AreEqual(31ULL, poly7.significant_coeff_count());
            for (int i = 0; i < 31; ++i)
            {
                Assert::IsTrue(1 == poly7[i]);
            }
            ...
            Assert::AreEqual(32ULL, poly8.significant_coeff_count());
