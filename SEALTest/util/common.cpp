    ...
    namespace util
    {
        ...
        public:
            ...
            TEST_METHOD(GetUInt64Byte)
            {
                ...
                Assert::IsTrue(SEAL_BYTE(0x21) == *get_uint64_byte(number, 0));
                Assert::IsTrue(SEAL_BYTE(0xF1) == *get_uint64_byte(number, 1));
                Assert::IsTrue(SEAL_BYTE(0xDE) == *get_uint64_byte(number, 2));
                Assert::IsTrue(SEAL_BYTE(0xBC) == *get_uint64_byte(number, 3));
                Assert::IsTrue(SEAL_BYTE(0x9A) == *get_uint64_byte(number, 4));
                Assert::IsTrue(SEAL_BYTE(0x78) == *get_uint64_byte(number, 5));
                Assert::IsTrue(SEAL_BYTE(0x56) == *get_uint64_byte(number, 6));
                Assert::IsTrue(SEAL_BYTE(0x34) == *get_uint64_byte(number, 7));
                Assert::IsTrue(SEAL_BYTE(0x12) == *get_uint64_byte(number, 8));
                Assert::IsTrue(SEAL_BYTE(0xEF) == *get_uint64_byte(number, 9));
                Assert::IsTrue(SEAL_BYTE(0xCD) == *get_uint64_byte(number, 10));
                Assert::IsTrue(SEAL_BYTE(0xAB) == *get_uint64_byte(number, 11));
                Assert::IsTrue(SEAL_BYTE(0x89) == *get_uint64_byte(number, 12));
                Assert::IsTrue(SEAL_BYTE(0x67) == *get_uint64_byte(number, 13));
                Assert::IsTrue(SEAL_BYTE(0x45) == *get_uint64_byte(number, 14));
                Assert::IsTrue(SEAL_BYTE(0x23) == *get_uint64_byte(number, 15));
            }

            TEST_METHOD(ReverseBits32)
            {
            ...
            TEST_METHOD(ReverseBits64)
            {
                Assert::AreEqual(0ULL, reverse_bits(0ULL));
                Assert::AreEqual(1ULL << 63, reverse_bits(1ULL));
                Assert::AreEqual(1ULL << 32, reverse_bits(1ULL << 31));
                Assert::AreEqual(0xFFFFULL << 32, reverse_bits(0xFFFFULL << 16));
                Assert::AreEqual(0x0000FFFFFFFF0000ULL, reverse_bits(0x0000FFFFFFFF0000ULL));
                Assert::AreEqual(0x0000FFFF0000FFFFULL, reverse_bits(0xFFFF0000FFFF0000ULL));

                Assert::AreEqual(0ULL, reverse_bits(0ULL, 0));
                Assert::AreEqual(0ULL, reverse_bits(0ULL, 1));
                Assert::AreEqual(0ULL, reverse_bits(0ULL, 32));
                Assert::AreEqual(0ULL, reverse_bits(0ULL, 64));

                Assert::AreEqual(0ULL, reverse_bits(1ULL, 0));
                Assert::AreEqual(1ULL, reverse_bits(1ULL, 1));
                Assert::AreEqual(1ULL << 31, reverse_bits(1ULL, 32));
                Assert::AreEqual(1ULL << 63, reverse_bits(1ULL, 64));

                Assert::AreEqual(0ULL, reverse_bits(1ULL << 31, 0));
                Assert::AreEqual(0ULL, reverse_bits(1ULL << 31, 1));
                Assert::AreEqual(1ULL, reverse_bits(1ULL << 31, 32));
                Assert::AreEqual(1ULL << 32, reverse_bits(1ULL << 31, 64));

                Assert::AreEqual(0ULL, reverse_bits(0xFFFFULL << 16, 0));
                Assert::AreEqual(0ULL, reverse_bits(0xFFFFULL << 16, 1));
                Assert::AreEqual(0xFFFFULL, reverse_bits(0xFFFFULL << 16, 32));
                Assert::AreEqual(0xFFFFULL << 32, reverse_bits(0xFFFFULL << 16, 64));

                Assert::AreEqual(0ULL, reverse_bits(0x0000FFFFFFFF0000ULL, 0));
                Assert::AreEqual(0ULL, reverse_bits(0x0000FFFFFFFF0000ULL, 1));
                Assert::AreEqual(0xFFFFULL, reverse_bits(0x0000FFFFFFFF0000ULL, 32));
                Assert::AreEqual(0x0000FFFFFFFF0000ULL, reverse_bits(0x0000FFFFFFFF0000ULL, 64));

                Assert::AreEqual(0ULL, reverse_bits(0xFFFF0000FFFF0000ULL, 0));
                Assert::AreEqual(0ULL, reverse_bits(0xFFFF0000FFFF0000ULL, 1));
                Assert::AreEqual(0xFFFFULL, reverse_bits(0xFFFF0000FFFF0000ULL, 32));
                Assert::AreEqual(0x0000FFFF0000FFFFULL, reverse_bits(0xFFFF0000FFFF0000ULL, 64));
            }
