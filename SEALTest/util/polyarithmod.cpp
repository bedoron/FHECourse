    ...
    namespace util
    {
        ...
        public:
            ...
            TEST_METHOD(MultiplyPolyScalarCoeffMod)
            {
                MemoryPool &pool = *global_variables::global_memory_pool;
                auto poly(allocate_zero_poly(3, 2, pool));
                auto scalar(allocate_uint(2, pool));
                auto modulus(allocate_uint(2, pool));
                poly[0] = 1;
                poly[2] = 3;
                poly[4] = 4;
            ...
            {
                MemoryPool &pool = *global_variables::global_memory_pool;
                auto poly1(allocate_zero_poly(5, 2, pool));
                auto poly2(allocate_zero_poly(5, 2, pool));
                auto result(allocate_zero_poly(5, 2, pool));
                auto quotient(allocate_zero_poly(5, 2, pool));
                auto modulus(allocate_uint(2, pool));
            ...
            TEST_METHOD(DyadicProductCoeffMod)
            {
                ...
                auto poly1(allocate_zero_poly(3, 2, pool));
                auto poly2(allocate_zero_poly(3, 2, pool));
                auto result(allocate_zero_poly(3, 2, pool));
                auto modulus(allocate_uint(2, pool));
            ...
            {
                MemoryPool &pool = *global_variables::global_memory_pool;
                auto poly1(allocate_zero_poly(4, 2, pool));
                auto poly2(allocate_zero_poly(4, 2, pool));
                auto polymod(allocate_zero_poly(4, 2, pool));
                auto result(allocate_zero_poly(4, 2, pool));
                auto modulus(allocate_uint(2, pool));
                poly1[0] = 1;
                poly1[2] = 2;
                poly1[4] = 3;
            ...
            TEST_METHOD(PolyEvalPolyPolyModCoeffMod)
            {
                ...
                auto polymod_anchor(allocate_zero_poly(3, 1, pool));
                polymod_anchor[0] = 2;
                polymod_anchor[1] = 0;
                polymod_anchor[2] = 1;
