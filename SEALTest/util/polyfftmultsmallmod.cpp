    ...
    namespace util
    {
        ...
        public:
            TEST_METHOD(SmallNTTMultiplyPolyPoly)
            {
                ...
                auto poly1(allocate_poly(4, 1, pool));
                auto poly2(allocate_poly(4, 1, pool));
                auto result(allocate_poly(4, 1, pool));
                ...
                auto correct(allocate_zero_poly(coeff_count, 1, pool));
                random_device rd;
                auto polymod(allocate_zero_poly(coeff_count, 1, pool));
                polymod[0] = 1;
                polymod[1024] = 1;
            ...
            TEST_METHOD(SmallNTTDotProductBigPolyArrayNTTBigPolyArray)
            {
                ...
                BigPolyArray testzero_arr1(3, 4, 7);
                BigPolyArray testzero_arr2(3, 4, 7);
                testzero_arr1.set_zero();
                testzero_arr2.set_zero();
                BigPoly(4, 7, testzero_arr1.data(0)) = "Ax^3 + Bx^2";
                BigPoly(4, 7, testzero_arr1.data(1)) = "Cx^1";
                BigPoly(4, 7, testzero_arr1.data(2)) = "Dx^2 + Ex^1 + F";
                ...
                BigPolyArray test_arr1(3, 4, 7);
                BigPolyArray test_arr2(3, 4, 7);
                test_arr1.set_zero();
                test_arr2.set_zero();
                BigPoly(4, 7, test_arr1.data(0)) = "6x^1 + 5";
                BigPoly(4, 7, test_arr1.data(1)) = "4x^3";
                BigPoly(4, 7, test_arr1.data(2)) = "3x^2 + 2x^1 + 1";
                BigPoly(4, 7, test_arr2.data(2)) = "1x^3 + 1x^2 + 1x^1 + 1";
                ...
                BigPolyArray arr1(2, 4, 7);
                BigPolyArray arr2(2, 4, 7);
                BigPoly(4, 7, arr1.data(0)) = "1x^1";
                BigPoly(4, 7, arr1.data(1)) = "1x^3";
                BigPoly(4, 7, arr2.data(0)) = "1";
                BigPoly(4, 7, arr2.data(1)) = "2x^1";
                for (int i = 0; i < 2; i++)
                {
                ...
                BigPolyArray scalartest1(1, 4, 7);
                BigPolyArray scalartest2(1, 4, 7);
                BigPoly(4, 7, scalartest1.data(0)) = "2";
                BigPoly(4, 7, scalartest2.data(0)) = "4x^3 + 4x^2 + 4x^1 + 4";
                ...
                BigPolyArray scalar_zero_test1(1, 4, 7);
                BigPolyArray scalar_zero_test2(1, 4, 7);
                BigPoly(4, 7, scalar_zero_test1.data(0)) = "17";
                BigPoly(4, 7, scalar_zero_test2.data(0)) = "0";
                ...
                BigPolyArray general1(4, 4, 7);
                BigPolyArray general2(4, 4, 7);
                BigPoly(4, 7, general1.data(0)) = "3x^2 + 2x^1";
                BigPoly(4, 7, general1.data(1)) = "1x^1 + 5";
                BigPoly(4, 7, general1.data(2)) = "1x^2 + 27";
                BigPoly(4, 7, general1.data(3)) = "3x^2 + 1x^1";
                BigPoly(4, 7, general2.data(0)) = "1x^3";
                BigPoly(4, 7, general2.data(1)) = "2x^1 + 6";
                BigPoly(4, 7, general2.data(2)) = "3x^1 + A";
                BigPoly(4, 7, general2.data(3)) = "12x^2 + Bx^1";
                for (int i = 0; i < 4; i++)
                {
                ...
                // General BigPolyArray, where we expect both mod and polymod reduction
                BigPolyArray general3(2, 4, 7);
                BigPolyArray general4(2, 4, 7);
                BigPoly(4, 7, general3.data(0)) = "Ax^1 + 1";
                BigPoly(4, 7, general3.data(1)) = "Cx^2 + 3";
                BigPoly(4, 7, general4.data(0)) = "Bx^1 + 2";
                BigPoly(4, 7, general4.data(1)) = "Dx^3 + 4";
                for (int i = 0; i < 2; i++)
                {
