    ...
    namespace util
    {
        ...
        public:
            TEST_METHOD(ModuloUInt)
            {
                ...
                auto result(allocate_uint(2, pool));
                value[0] = 0;
                value[1] = 0;
                value[2] = 0;
                modulus[0] = 2;
            ...
            {
                MemoryPool &pool = *global_variables::global_memory_pool;
                auto prime_modulus_anchor(allocate_uint(2, pool));
            ...
            TEST_METHOD(IsPrimitiveRoot)
            {
                MemoryPool &pool = *global_variables::global_memory_pool;
                auto prime_modulus_anchor(allocate_uint(2, pool));
                auto root(allocate_uint(2, pool));
            ...
            TEST_METHOD(ExponentiateUIntMod)
            {
                ...
                auto result(allocate_zero_uint(2, pool));
                auto modulus(allocate_zero_uint(2, pool));
                auto exponent(allocate_zero_uint(2, pool));
