    ...
    namespace util
    {
        ...
        public:
            ...
            {   
                ...
                ptr[0] = 0;
                ptr[1] = 0;
                Assert::AreEqual(0ULL, get_significant_uint64_count_uint(ptr.get(), 2));

                ptr[0] = 1;
                ptr[1] = 0;
                Assert::AreEqual(1ULL, get_significant_uint64_count_uint(ptr.get(), 2));
                ...
                ptr[0] = 0;
                ptr[1] = 1;
                Assert::AreEqual(2ULL, get_significant_uint64_count_uint(ptr.get(), 2));
