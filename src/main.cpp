...
void example_bfv_basics_i()
{
    ...
    A fourth parameter -- noise_standard_deviation -- has a default value 3.19 
...
void example_bfv_basics_iv()
{
    ...
    */
    decryptor.decrypt(encrypted, plain);
    cout << "Decryption of eighth power: " << plain.to_string() << endl;
    ...
    */
    cout << "Current coeff_modulus size: "
        << context->context_data(encrypted.parms_id())->
            total_coeff_modulus().significant_bit_count()
        << " bits" << endl; 
...
void example_ckks_basics_iii()
{
    ...
    different degress in the polynomial evaluation. We start by setting up an
    ...
    */
    ...
    with three sizes of Galois keys, as follows.
    */
    auto gal_keys60 = keygen.galois_keys(60); 
    auto gal_keys30 = keygen.galois_keys(30); 
    auto gal_keys15 = keygen.galois_keys(15); 
    ...
    evaluator.rotate_vector(encrypted_result, 1, gal_keys60, rotated_result); 
    decryptor.decrypt(rotated_result, plain_result);
    encoder.decode(plain_result, result);
    cout << "Result rotated with dbc 60:" << endl;
